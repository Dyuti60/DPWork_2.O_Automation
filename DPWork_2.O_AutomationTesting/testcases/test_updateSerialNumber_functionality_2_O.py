                        ...
                        if self.dpup.checkInitiationInformationErrorMessage(dikshayatriStatus='',familyCode='',phoneNumber=''):
                            ...
                            if self.dpup.checkPermanentAddressInformationErrorHandling(permanentAddress='',permanentLandmark='',permanentPincode='',permanentPostoffice=''):
                                ...
                                if self.dpup.checkPresentAddressInformationErrorHandling(checkBoxStatus='No',presentAddress='',presentLandmark='',presentPincode='',presentPostoffice=''):
                                    ...
                                    self.dpup.clickCheckBoxForPresentAddressSameAsPermanentAddress(list(updateSerialNumberActiveMemberTestDataDict[update_checkBox_flag])[index])
                                    ss03_location=docsutil.takeAndSaveScreenshotUnique(self.screenshot_location,'Update Serial Number - Active','29A',self.driver)
                                    docsutil.addSmallHeading(self.document,"User enters the Present Address")
                                    docsutil.insertImageInDocx(self.document,ss03_location)
                                    self.logging.info("User clicks the checkbox -".format(list(updateSerialNumberActiveMemberTestDataDict[update_checkBox_flag])[index]))

                                    self.dpup.enterPresentAddress(list(updateSerialNumberActiveMemberTestDataDict[update_presentAddress])[index],list(updateSerialNumberActiveMemberTestDataDict[update_checkBox_flag])[index])
                                    ...
                                    self.dpup.enterPresentLandmark(list(updateSerialNumberActiveMemberTestDataDict[update_presentLandmark])[index],list(updateSerialNumberActiveMemberTestDataDict[update_checkBox_flag])[index])
                                    ...
                                    self.dpup.enterPresentPincode(list(updateSerialNumberActiveMemberTestDataDict[update_presentPincode])[index],list(updateSerialNumberActiveMemberTestDataDict[update_checkBox_flag])[index])
                                    ...
                                    self.dpup.enterPresentPostOffice(list(updateSerialNumberActiveMemberTestDataDict[update_presentPostoffice])[index],list(updateSerialNumberActiveMemberTestDataDict[update_checkBox_flag])[index])
                ...
                if(self.dpup.CheckForText_Search_by_member_id() and self.dpup.CheckForText_Update_Title() and self.dpup.CheckForButton_Clear() and self.dpup.CheckForButton_Search()):
                    ...
                    if self.dpup.validateUpdateStatus(updateStatus):
                        ...
                        if self.dpup.checkInitiationInformationErrorMessage(dikshayatriStatus='',familyCode='',phoneNumber=''):
                            ...
                            self.dpup.clickCheckBoxForPresentAddressSameAsPermanentAddress(list(updateSerialNumberInActiveMemberTestDataDict[update_checkBox_flag])[index])
                            ss03_location=docsutil.takeAndSaveScreenshotUnique(self.screenshot_location,'Update Serial Number - Active','29A',self.driver)
                            docsutil.addSmallHeading(self.document,"User enters the Present Address")
                            docsutil.insertImageInDocx(self.document,ss03_location)
                            self.logging.info("User clicks the checkbox -".format(list(updateSerialNumberInActiveMemberTestDataDict[update_checkBox_flag])[index]))
                            
                            self.dpup.enterPresentAddress(list(updateSerialNumberInActiveMemberTestDataDict[update_presentAddress])[index],list(updateSerialNumberInActiveMemberTestDataDict[update_checkBox_flag])[index])
                            ...
                            self.dpup.enterPresentLandmark(list(updateSerialNumberInActiveMemberTestDataDict[update_presentLandmark])[index],list(updateSerialNumberInActiveMemberTestDataDict[update_checkBox_flag])[index])
                            ...
                            self.dpup.enterPresentPincode(list(updateSerialNumberInActiveMemberTestDataDict[update_presentPincode])[index],list(updateSerialNumberInActiveMemberTestDataDict[update_checkBox_flag])[index])
                            ...
                            self.dpup.enterPresentPostOffice(list(updateSerialNumberInActiveMemberTestDataDict[update_presentPostoffice])[index],list(updateSerialNumberInActiveMemberTestDataDict[update_checkBox_flag])[index])
